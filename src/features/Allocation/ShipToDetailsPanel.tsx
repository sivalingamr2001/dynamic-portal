      ...
      <div className="space-y-1 relative">
        ...
        {customerType === 'new' ? (
          ...
          <div className="relative">
            ...
            />
            {openDropdown && (
              <div className="absolute top-full bg-muted left-0 z-50 mt-1 max-h-48 w-full overflow-y-auto rounded-md border bg-popover shadow-md border-border" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="space-y-1">
        ...
        {customerType === 'new' ? (
          ...
          <select
            ...
            disabled={!selectedShipToId || locations.length === 0}
          ...
          >
            <option value="">{selectedShipToId ? "Choose site location" : "Select customer first"}</option>
