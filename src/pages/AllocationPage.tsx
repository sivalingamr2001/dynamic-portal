...
import CustomerForm from "@/components/allocation/CustomerForm";
import ItemLines from "@/components/allocation/ItemLines";
import OpenPoolForm from "@/components/allocation/OpenPoolForm";
      ...
      <div className="mx-auto flex flex-col gap-4">
        ...
        <div className="bg-white rounded border border-slate-200 p-3 shadow-2xs">
          ...
          <ItemLines
            ...
            itemCodeOptions={allocationHook.itemsData?.data.map((item: { inventoryItemId: any; itemCode: any; description: any; }) => ({
